            ...
            <tbody>
                ...
                %>
                    ...
                    <tr>
                        ...
                        <td><a id="aa" href="jsp/international_booking.jsp?flightId=<%= flight.getFlightId() %>&source_city=<%= flight.getSourceCity() %>&destination_city=<%= flight.getDestinationCity() %>&ArrivalTime=<%= flight.getArrivalTime() %>&DepartureTime=<%= flight.getDepartureTime() %>">Book</a></td>
                    </tr>
                <% 
                    }
                %>
